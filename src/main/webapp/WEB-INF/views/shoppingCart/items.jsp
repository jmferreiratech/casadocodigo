            ...
            <nav id="main-nav">
                <ul class="clearfix">
                    ...
                    <li>
                        ...
                        <a href="${spring:mvcUrl('SCC#items').build()}" rel="nofollow">Seu
                            carrinho(${shoppingCart.quantity})
                        </a>
                    </li>
...
<section class="container middle">
    ...
    <table id="cart-table">
        ...
        <tfoot>
        <tr>
            <td colspan="2"><input type="submit" class="checkout" name="checkout" value="Finalizar compra "
                                   id="checkout"/></td>
    ...
    <ul id="collection" class="related-books">
        ...
        <li class="col-left">
            <a href="/products/livro-mean" class="block clearfix book-suggest"
        ...
        <li class="col-right">
            <a href="/products/livro-certificacao-java-associate" class="block clearfix book-suggest"
        ...
        <li class="col-left">
            <a href="/products/livro-sql-oracle" class="block clearfix book-suggest"
        ...
        <li class="col-right">
            <a href="/products/livro-orientacao-objetos-java" class="block clearfix book-suggest"
        ...
        <li class="col-left">
            <a href="/products/livro-android" class="block clearfix book-suggest"
