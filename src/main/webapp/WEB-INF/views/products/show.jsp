...
<fmt:message key="products.list-title" var="title" />
<customTags:page title="" bodyClass="">
        ...
        <header id="product-highlight" class="clearfix">
            <div id="product-overview" class="container">
                ...
                <p itemprop="description" class="book-description">
                        ${product.description}
                    Veja o <a href="<c:url value='/${product.summaryPath}'/>" target="_blank">sum&#225;rio</a> completo
                    do
                    livro! </p>
            </div>
        </header>
                    ...
                    <c:forEach items="${product.prices}" var="price">
                        <li class="buy-option">
                            ...
                            <label class="variant-label"
                                   for="${product.id}-${price.bookType}"> ${price.bookType} </label>
